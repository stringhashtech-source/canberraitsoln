        ...
        <div
          ...
          <div className='flex gap-2 items-center'>
            ...
            <span className='font-medium text-midnight_text text-sm dark:text-white/50'>
              BUILD EVERYTHING - Your Trusted IT Partner
            </span>
          </div>
          ...
          <p className='text-grey dark:text-white/70 text-xl font-semibold'>
            Canberra IT Solutions : Australian owned and operated IT solutions provider dedicated to
            empowering businesses with cutting-edge technology and exceptional
            service.
          </p>
          <a
  href="#learn-more"
  className="py-3 px-8 bg-[#3CD278] text-white rounded-md 
             hover:bg-[#34bd6d] transition duration-300"
>
  Get Started
</a>
  ...
  Need help?{" "}
  <a
    href="https://mail.google.com/mail/?view=cm&fs=1&to=admin@canberraitsolutions.com.au"
    target="_blank"
