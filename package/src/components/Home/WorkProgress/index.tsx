        ...
        <div className='grid md:grid-cols-12 items-center gap-7'>
          ...
          <div
            ...
            <h2 className='pt-9 pb-8 text-midnight_text font-bold dark:text-white text-4xl'>
              Build your product with confidence and clarity.
            </h2>
            <p className='text-gray dark:text-white/70 text-base font-semibold'>
              We follow a structured work progress approach to ensure timely delivery and
              high-quality results for our clients.Including Web Development, Mobile App, UI/UX, System Infrastructure. Our team of experts utilizes industry best practices and cutting-edge technologies to deliver exceptional solutions that meet your business needs.
            </p>
